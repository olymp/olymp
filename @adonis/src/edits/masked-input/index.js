...
var MaskedInput = React.createClass({
  ...
  _updateMaskSelection() {
    this.mask.selection = getSelection(ReactDOM.findDOMNode(this))
  },

  _updateInputSelection() {
    setSelection(ReactDOM.findDOMNode(this), this.mask.selection)
  },
  ...
  _onChange(e) {
    ...
    if (e.target.value != maskValue) {
      // Cut or delete operations will have rtened the value
  ...
  render() {
    ...
    var patternLength = this.mask.pattern ? this.mask.pattern.length : 0;
