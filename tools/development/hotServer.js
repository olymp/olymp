...
class HotServer {
  constructor(compiler) {
    ...
    this.watcher = chokidar.watch([path.resolve(__dirname, '../../src/server'), path.resolve(appRootPath, 'server'), path.resolve(__dirname, '..', '..', 'graphql')].concat((modules && modules.server) || []));
