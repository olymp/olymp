  ...
  render() {
    ...
    return (
      <LightBox
        ...
        onClickPrev={() => router.push({ pathname, query: { ...query, lightbox: images[prevIndex].ref } })}
        onClickNext={() => router.push({ pathname, query: { ...query, lightbox: images[nextIndex].ref } })}
        onClickThumbnail={i => router.push({ pathname, query: { ...query, lightbox: images[i].ref } })}
