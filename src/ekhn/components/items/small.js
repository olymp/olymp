...
import { SlateMate, Image, useItemEdit, useItemHide, useItemOrder } from 'olymp/cms';
...
export default class Items extends Component {
  render() {
    const { id, header, subheader, shortText, more, bild, tags, location, identifier, className } = this.props;
