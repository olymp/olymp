...
var MainList = (0, _olymp.withCollection)(_class = (0, _olymp.withApollo)(_class = (0, _olymp.withRouter)(_class = (_temp = _class2 = function (_Component) {
    ...
    _this.update = function (nextProps, lastProps) {
      if (!lastProps || nextProps.collection !== lastProps.collection) {
        ...
        var query = client.watchQuery({
          ...
          query: (0, _olymp.gql)(_templateObject, lname, lname, attributes), /* eslint-disable */
          variables: {
  ...
  _createClass(MainList, [{
    ...
    value: function render() {
      ...
      fields = (0, _lodash.sortBy)(fields, 'index');
      ...
      var changeState = function changeState(state) {
        return selectedRowKeys.forEach(function (key) {
          return saveCollectionItem(_extends({}, (0, _lodash.find)(items, function (obj) {
            return obj.id === key;
          }), {
            state: state
          }));
