  ...
  return Editor =>
    class SlateSidebarDecorator extends Component {
        ...
        return (
          <Menu.Item key={props.type} style={{ minWidth: '150px' }}>
            ...
            >
              ...
              {props.icon ? ' ' : null}{props.label || props.type}
            </a>
          </Menu.Item>
        );
      };
      ...
      renderSidebar = () => {
        ...
        return (
          <div
            className="slate-sidebar"
            ref={ref => (this.gwRef = ref)}
            key="gw-sidebar"
          >
      ...
      render() {
        const children = this.props.readOnly
          ? this.props.children
          : [...Children.toArray(this.props.children), this.renderSidebar()];
        return (
          <Editor {...this.props}>
            {children}
          </Editor>
