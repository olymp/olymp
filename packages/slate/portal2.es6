...
class Card extends React.Component {
  ...
  getArrowStyle() {
    ...
    const arrowStyle = assign(this.defaultArrowStyle, this.props.style.arrowStyle);
    ...
    const fgTransBorder = `${fgSize}px solid transparent`;
    const bgColorBorder = `11px solid ${bgBorderColor}`;
    const bgTransBorder = `${bgSize}px solid transparent`;
...
export default class ToolTip extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    const newProps = assign({}, nextProps);
