...
const ImageWithLabel = createComponent(({ width }) => ({
  width,
  position: 'relative',
  ...
  return (
    <div className={className} {...attributes}>
      <Image.Image contentEditable={false} value={image} width={width} alt="" />
...
export default {
  ...
  component: ({ getData, ...p }) => (
    <ImageWithLabel
      {...p}
      image={getData('value', [{ url: 'http://placekitten.com/1100/330', caption: 'Eine Katze', source: 'Der Text hier solange zu sehen bis Beni den Bug mit editable false behebt!' }])[0]}
