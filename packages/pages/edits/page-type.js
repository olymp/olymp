...
var PageTypeInput = function (_a) {
    ...
    return (React.createElement(Form.Item, __assign({ key: field, label: label }, layout), form.getFieldDecorator(field, {
        ...
        React.createElement(Select.Option, { value: "PAGE" }, "Seite"),
        React.createElement(Select.Option, { value: "MENU" }, "Men\u00FC"),
        React.createElement(Select.Option, { value: "PLACEHOLDER" }, "Platzhalter"),
        React.createElement(Select.Option, { value: "ALIAS" }, "Alias"),
        React.createElement(Select.Option, { value: "LINK" }, "Externer Link")))));
};
